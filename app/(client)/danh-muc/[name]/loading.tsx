...
function CategorySkeleton() {
  return (
    <div className="col-span-2 sm:col-span-4 mt-4">
      <div className="col-span-full container px-0 sm:my-6 grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-2 sm:gap-4">
        {Array.from({ length: 12 }).map((_, index) => (
          ...
          >
            ...
            <div className="px-1 sm:px-4 pb-2 flex flex-col space-y-2">
