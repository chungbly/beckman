import Error from "@/components/app-layout/error";
...
function Page404() {
  return (
    <Error
      title="Thật tiếc, không tìm thấy trang này"
      message={
        <>
          Oops! Trang bạn đang tìm không tồn tại.
          <br />
          Bạn có thể đã nhập sai địa chỉ. Hãy kiểm tra lại đường dẫn nhé!
        </>
      }
      content={
        <svg viewBox="0 0 480 360" xmlns="http://www.w3.org/2000/svg">
          ...
          ></path>
          <image
            href="/illustrations/character.png"
            height="300"
            x="205"
            y="30"
          ></image>
