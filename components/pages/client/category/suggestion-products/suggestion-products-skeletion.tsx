...
function SuggestionProductSkeleton() {
  return (
    <div className="col-span-full container sm:my-6 grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 xl:grid-cols-6 gap-2 sm:gap-4  ">
      {Array.from({ length: 6 }).map((_, index) => (
        <div
          key={index}
          className="col-span-1 bg-white shadow-md space-y-2 max-sm:snap-start max-sm:h-[calc(100dvh-var(--header-mobile-height))]"
        >
