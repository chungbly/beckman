      ...
      >
        <div className="flex flex-wrap gap-1">
          ...
          <CommandPrimitive.Input
            ...
            className={cn(
              "ring-0 outline-none border-0 ring-transparent focus:ring-0 focus:outline-none focus:border-0 focus:ring-transparent placeholder:text-muted-foreground/70 flex-1 bg-transparent outline-hidden disabled:cursor-not-allowed",
              {
